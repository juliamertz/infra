{
  ...
  kubernetes = {
    ...
    resources.configMaps.nettenshop-dashboard = {
      metadata.labels.grafana_dashboard = "1";
      data."nettenshop.json" = builtins.readFile ./dashboards/nettenshop.json;
    };

    resources.configMaps.headscale-dashboard = {
      metadata.labels.grafana_dashboard = "1";
      data."headscale.json" = builtins.readFile ./dashboards/headscale.json;
    };

    resources.configMaps.cloudnative-pg-dashboard = {
      metadata.labels.grafana_dashboard = "1";
      data."cloudnative-pg.json" = builtins.readFile ./dashboards/cloudnative-pg.json;
    };
